...
> Commercial positioning summary — technical claims herein are simplified; [README.md](../../README.md) and [SECURITY_MATURITY.md](../security/SECURITY_MATURITY.md) govern where they differ.
...
Citadel maps to 34 controls in NIST SP 800-57: 27 satisfied, 6 partially satisfied, 1 gap. See ../security/COMPLIANCE_MATRIX.md for the full mapping.
...
| FIPS validation | **Not a validated deployment.** The optional `fips` build routes envelope operations through a CMVP-validated AWS-LC module, but that does not make Citadel itself a validated product — see [SECURITY_MATURITY.md](../security/SECURITY_MATURITY.md). |
