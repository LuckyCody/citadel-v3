...
> **Historical (Python→Rust, v1 era).** Describes the v1 envelope; the current format is v2 ([WIRE_SPEC_V2.md](../spec/WIRE_SPEC_V2.md)). Retained for prototype-data migration only.
