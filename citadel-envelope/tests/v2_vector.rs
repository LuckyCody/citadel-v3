...
fn deterministic_vector_matches_independent_transcript_reconstruction() {
    ...
    // Packet 056: the KDF/AAD bind only the nonce-free header prefix (header[..86]); the
    // module-generated nonce at header[86..98] is excluded and authenticated by AES-GCM itself.
